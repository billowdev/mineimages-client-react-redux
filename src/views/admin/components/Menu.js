...
<aside className="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index3.html" className="brand-link">
    <img src={require('../../assets/images/mineimageslogo.png')} alt="logo" className="brand-image img-circle elevation-3" style={{opacity: '.8'}} />
    <span className="brand-text font-weight-light">MINEIMAGES</span>
  </a>
  {/* Sidebar */}
