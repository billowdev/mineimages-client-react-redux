...
export const GET_IMAGE_BY_ID_FAILED = "[IMAGES] GET BY ID FAILED";
...
export const getImageByIdFailed = (error) => ({
  type: GET_IMAGE_BY_ID_FAILED,
  payload: error,
});
...
export const UPLOAD_IMAGE_SUCCESS = "[IMAGE.UPLOAD]  SUCCESS";
export const UPLOAD_IMAGE_FAILED = "[IMAGE.UPLOAD] FAILED";
